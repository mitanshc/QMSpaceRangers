...
# Try importing RPi.GPIO; use a mock if unavailable
try:
    ...
    GPIO = MockGPIO()  # Use mock GPIO when running on a PC
...
class RoverControlNode(Node):
    def __init__(self):
        ...
        self.track_width = 0.5  # Adjust if needed
